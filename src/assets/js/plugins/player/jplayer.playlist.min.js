/*! jPlayerPlaylist for jPlayer 2.9.2 ~ (c) 2009-2014 Happyworm Ltd ~ MIT License */ ! function(a, b) {
    jPlayerPlaylist = function(b, c, d) {
        ...
        _createListItem: function(b) {
            ...
            if (d += "<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>", b.free) {
             ...
             return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'><span class='que_img'><img style='height: 50px; width: 50px' src='"+b.image+"'></span ><div class='que_data'>" + b.title + (b.artist ? " <span class='jp-singer'>by " + b.artist + "</span>" : "") + "</div></a>", d += "<div class='action'><span class='que_more'><img src='/assets/images/svg/more.svg'></span><span class='que_close'><img src='/assets/images/svg/close.svg'></span></div></div>"+b.option+"</li>"
        },
    ...
    module.exports = {jPlayerPlaylist};
}(jQuery);
